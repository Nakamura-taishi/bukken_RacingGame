...
{
    [RequireComponent(typeof (t_CarController))]
    public class t_CarAIControl : MonoBehaviour
    {
        ...
        private t_CarController m_CarController;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            m_CarController = GetComponent<t_CarController>();
        ...
        private void OnCollisionStay(Collision col)
        {
            ...
            {
                var otherAI = col.rigidbody.GetComponent<t_CarAIControl>();
                if (otherAI != null)
                {
