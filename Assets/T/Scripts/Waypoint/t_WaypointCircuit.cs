...
{
    public class t_WaypointCircuit : MonoBehaviour
    {
        ...
        {
            public t_WaypointCircuit circuit;
...
{
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(t_WaypointCircuit.WaypointList))]
    public class WaypointListDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                var circuit = property.FindPropertyRelative("circuit").objectReferenceValue as t_WaypointCircuit;
